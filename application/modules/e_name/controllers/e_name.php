...
public function index()
	{
            ...
            $data['page_title'] = "Equipment Model";
            $data['module']="e_name";
      ...
      function submit (){
        ...
        {       
         ...
         if(is_numeric($update_id)){
           ...
           $this->session->set_flashdata('msg', '<div id="alert-message" class="alert alert-success text-center">Equipment Model details updated successfully!</div>');

         } else {
           $this->_insert($data);
           $this->session->set_flashdata('msg', '<div id="alert-message" class="alert alert-success text-center">New Equipment Model added successfully!</div>');
         }
